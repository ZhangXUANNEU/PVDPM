...
from var_models.attn import ThreeStageAttentionLayer
...
class scale_block(nn.Module):
    ...
    def __init__(self, win_size, d_model, n_heads, d_ff, depth, dropout, \
        ...
        for i in range(depth):
            self.encode_layers.append(ThreeStageAttentionLayer(seg_num, factor, d_model, n_heads, \
                                                        d_ff, dropout))
